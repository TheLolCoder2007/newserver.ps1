...
Write-Host -Object "This translation is made by google translate. If there are any faults in the translation, please repair it. The repo is https://github.com/thelolcoder2007/newserver.ps1/"#Translate this in the language too
