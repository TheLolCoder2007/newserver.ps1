...
$compnamequestion = "Wat is de computernaam "#What is your computer name/ip adress for the server where you want to host the server on? This need to be an linux host.
